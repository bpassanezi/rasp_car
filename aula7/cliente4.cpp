...
int main(int argc, char *argv[]){
    ...
    while (ch<0) {
        ...
        cv:Rect rect;
        rect = visao.printSQR(camera_display, quadrado);
        
        for(int i = 0; i < 10; i++){
            if(i == 0){
                novo_estado = visao.printNumber(ind, mnist, camera_display, rect);
            }
            else if(i == 1){
                novo_estado1 = visao.printNumber(ind, mnist, camera_display, rect);
            }
            else if(i == 2){
                novo_estado2 = visao.printNumber(ind, mnist, camera_display, rect);
            }
            else if(i == 3){
                novo_estado3 = visao.printNumber(ind, mnist, camera_display, rect);
            }
            else if(i == 4){
                novo_estado4 = visao.printNumber(ind, mnist, camera_display, rect);
            }
            else if(i == 5){
                novo_estado5 = visao.printNumber(ind, mnist, camera_display, rect);
            }
            else if(i == 6){
                novo_estado6 = visao.printNumber(ind, mnist, camera_display, rect);
            }
            else if(i == 7){
                novo_estado7 = visao.printNumber(ind, mnist, camera_display, rect);
            }
            else if(i == 8){
                novo_estado8 = visao.printNumber(ind, mnist, camera_display, rect);
            }
            else if(i == 9){
                novo_estado9 = visao.printNumber(ind, mnist, camera_display, rect);
            }
        }

        number = visao.printNumber(ind, mnist, camera_display, rect);
